...
class ImageRegressor(object):
    ...
    def __init__(self, test_batch_size, n_jobs,
    ...
    def train_submission(self, module_path, x_list, y_list,
                         train_is=None):
        ...
        X_array : list containing the pointers to each image in low resolution (np.array)
        y_array : list containing the pointers to each image in high resolution
